...
New Cloud Volumes ONTAP features are also introduced in the latest versions of the NetApp Console. See the https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html[Cloud Volumes ONTAP Release Notes^] for details.
