...
== 9.16.1 P7 (9 October 2025)
The 9.16.1 P7 patch can now be deployed and upgraded for Cloud Volumes ONTAP in Azure and Google Cloud. However, this version is unavailable for deployment and upgrade in AWS. NetApp Console will prompt you to upgrade your existing systems to this patch release.
...
== 9.16.1 P6 (9 October 2025)
The 9.16.1 P6 patch can now be deployed and upgraded for Cloud Volumes ONTAP in Azure and Google Cloud. However, this version is unavailable for deployment and upgrade in AWS. NetApp Console will prompt you to upgrade your existing systems to this patch release.
