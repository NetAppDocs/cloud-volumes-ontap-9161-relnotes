...
##The Cloud Volumes ONTAP 9.16.1 General Availability release is now available in AWS, Azure, and Google Cloud. The GA version is available for deployment and upgrade.##
