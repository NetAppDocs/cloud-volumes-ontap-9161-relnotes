...
The Cloud Volumes ONTAP 9.16.1 P8 patch is now available for upgrade in Azure and Google Cloud. However, this version is unavailable for upgrade in AWS. The Console will prompt you to upgrade your existing systems to this patch release.
...
The Cloud Volumes ONTAP 9.16.1 P7 patch is now available for upgrade in Azure and Google Cloud. However, this version is unavailable for upgrade in AWS. The Console will prompt you to upgrade your existing systems to this patch release.
...
The Cloud Volumes ONTAP 9.16.1 P6 patch is now available for upgrade in Azure and Google Cloud. However, this version is unavailable for upgrade in AWS. The Console will prompt you to upgrade your existing systems to this patch release.
